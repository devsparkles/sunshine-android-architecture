...
class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    void swapForecast(final List<ListWeatherEntry> newForecast) {
        ...
        if(mForecast == null){
            ...
            /**
             * Otherwise we use DiffUtil to calculate the changes and update accordingly.
             * This shows the four methods our need to override to return a DiffUtil callback the old list
             * is the current list sotred in mForecast, where the new listist
             * the new values passed in from the observing the databas
             */
